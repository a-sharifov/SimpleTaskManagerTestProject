...
Clean Architecture: Domain (aggregates, Value Objects, SmartEnum), Application (commands/queries via MediatR), Persistence (EF Core, repositories), Api (MVC controllers + Razor Views).
